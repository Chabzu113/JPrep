...
const APCALC_MCQ = [
  ...
  },
  {
        ...
        calculator: true,
        type: "table",
        question: "A particle moves along the x-axis. Selected values of its velocity v(t) are shown in\nthe table. Using a left Riemann sum with 3 subintervals, approximate the displacement of the\nparticle from t = 0 to t = 6.\\n\\n| t | 0 | 2 | 4 | 6 |\\n|---|---|---|---|---|\\n| v(t) | 3 | −1 | 2 | 5 |",
        isLatex: false,
        choices: ["8", "6", "4", "10"],
        answer: 0,
