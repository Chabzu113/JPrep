...
public class Game {
    ...
    rubric: [
      { points: 1, description: '(a) Accesses each element of targets array', index: 1, skill: 'code', partLabel: 'a', keywords: ['for', 'while', 'targets', 'targets.length', 'targets['] },
      { points: 1, description: '(a) Correctly compares target value to min using >', index: 2, skill: 'code', partLabel: 'a', keywords: ['>', 'min', '< min', 'threshold'] },
      { points: 1, description: '(a) Accumulates sum of qualifying elements', index: 3, skill: 'code', partLabel: 'a', keywords: ['+=', 'sum +=', 'total +=', 'result +=', 'min'] },
      { points: 1, description: '(a) Returns correct sum', index: 4, skill: 'code', partLabel: 'a', keywords: ['return', 'sum', 'total', 'result'] },
      { points: 1, description: '(b) Accesses each element of targets array', index: 5, skill: 'code', partLabel: 'b', keywords: ['for', 'while', 'targets', 'targets.length', 'targets['] },
...
4. Have a toString() method returning: "title - author - Edition: N"`,
    ...
    rubric: [
      ...
      { points: 1, description: 'Constructor correctly initializes all instance variables', index: 2, skill: 'code', partLabel: 'a', keywords: ['this.', '=', 'title', 'author', 'edition'] },
      { points: 1, description: 'getEdition() returns the edition', index: 3, skill: 'code', partLabel: 'a', keywords: ['return', 'edition', 'getEdition'] },
      ...
      { points: 1, description: 'toString() returns correct format', index: 7, skill: 'code', partLabel: 'a', keywords: ['return', 'Edition:', 'toString'] }
    ],
...
public class ArrayResizer {
    ...
    rubric: [
      { points: 1, description: '(a) Accesses each element of the 1D array', index: 1, skill: 'code', partLabel: 'a', keywords: ['for', 'while', 'arr', 'isNonZeroRow'] },
      ...
      { points: 1, description: '(b) Returns the new array', index: 7, skill: 'code', partLabel: 'b', keywords: ['return', 'result', 'resize'], cpeSource: 'a' }
    ],
...
public static boolean canMove(int[][] board, Position pos, int direction) {
    ...
    rubric: [
      { points: 1, description: '(a) Traverses all elements of the 2D array', index: 1, skill: 'code', partLabel: 'a', keywords: ['for', 'while', 'board', 'Position', 'findMax'] },
...
public class AppointmentBook {
    ...
    rubric: [
      { points: 1, description: '(a) Iterates through hours starting at startHour', index: 1, skill: 'code', partLabel: 'a', keywords: ['for', 'while', 'numHours', 'startHour'] },
...
- splitIntoLines(String message) returns a String array where each element
  ...
  If the message is shorter than getArea(), remaining lines are empty strings.`,
    ...
    rubric: [
      { points: 1, description: 'Declares appropriate private instance variables', index: 1, skill: 'code', partLabel: 'a', keywords: ['private'] },
      { points: 1, description: 'Constructor initializes fields correctly', index: 2, skill: 'code', partLabel: 'a', keywords: ['this.', '=', 'numberOfLines', 'lineWidth'] },
...
public class WeatherData {
    ...
    rubric: [
      ...
      { points: 1, description: '(a) Returns correct average as double', index: 3, skill: 'code', partLabel: 'a', keywords: ['return', 'sum', 'total', 'avg'] },
      ...
      { points: 1, description: '(b) Iterates through the list correctly', index: 5, skill: 'code', partLabel: 'b', keywords: ['for', 'while', 'temperatures'], cpeSource: 'a' },
...
public static int[] climbPath(int[][] mountain) {
    ...
    rubric: [
      ...
      { points: 1, description: '(a) Traverses each column in the row', index: 2, skill: 'code', partLabel: 'a', keywords: ['for', 'while', 'mountain', 'peakColumn'] },
      {
        points: 1,
      ...
      { points: 1, description: '(a) Returns correct column index', index: 4, skill: 'code', partLabel: 'a', keywords: ['return', 'maxCol', 'col', 'index'] },
      ...
      { points: 1, description: '(b) Returns the array of column indices', index: 7, skill: 'code', partLabel: 'b', keywords: ['return', 'path', 'result', 'cols'], cpeSource: 'a' }
    ],
...
public class Feeder {
    ...
    rubric: [
      { points: 1, description: '(a) Loops over each bird (numBirds iterations)', index: 1, skill: 'code', partLabel: 'a', keywords: ['for', 'while', 'numBirds', 'simulateOneDay'] },
      ...
      { points: 1, description: '(b) Loops numDays times', index: 5, skill: 'code', partLabel: 'b', keywords: ['for', 'while', 'numDays'], cpeSource: 'a' },
      {
        points: 1,
      ...
      { points: 1, description: '(b) Counts and returns days with numBirds > 0', index: 7, skill: 'code', partLabel: 'b', keywords: ['return', '>', 'count', 'days'], cpeSource: 'a' }
    ],
...
- isLeading(String team) — returns true if the given team has a strictly higher score`,
    ...
    rubric: [
      { points: 1, description: 'Declares appropriate private instance variables', index: 1, skill: 'code', partLabel: 'a', keywords: ['private'] },
      { points: 1, description: 'Constructor initializes team names and scores to 0', index: 2, skill: 'code', partLabel: 'a', keywords: ['this.', '=', 'teamA', 'teamB'] },
...
public class WordChecker {
    ...
    rubric: [
      { points: 1, description: '(a) Iterates through wordList', index: 1, skill: 'code', partLabel: 'a', keywords: ['for', 'while', 'wordList'] },
      ...
      { points: 1, description: '(a) Returns correct count', index: 3, skill: 'code', partLabel: 'a', keywords: ['return', 'count', 'total'] },
      { points: 1, description: '(b) Iterates through list (correctly handling shifting)', index: 4, skill: 'code', partLabel: 'b', keywords: ['for', 'while', 'wordList'], cpeSource: 'a' },
...
public class LightBoard {
    ...
    rubric: [
      ...
      { points: 1, description: '(a) Loops through all positions', index: 2, skill: 'code', partLabel: 'a', keywords: ['for', 'while', 'numRows', 'numCols'] },
      ...
      { points: 1, description: '(b) Returns correct boolean value', index: 7, skill: 'code', partLabel: 'b', keywords: ['return', 'onCount', 'count', '% 2'], cpeSource: 'a' }
    ],
...
public class StringAnalyzer {
    ...
    rubric: [
      { points: 1, description: '(a) Iterates through each character of s', index: 1, skill: 'code', partLabel: 'a', keywords: ['for', 'while', 'countUppercase'] },
...
public class NumberUtils {
    ...
    rubric: [
      ...
      { points: 1, description: '(b) Iterates from 1 (or 2) to max', index: 5, skill: 'code', partLabel: 'b', keywords: ['for', 'while', 'isPrime', 'max'], cpeSource: 'a' },
...
public class Library {
    ...
    rubric: [
      ...
      { points: 1, description: 'toString() returns correct format', index: 7, skill: 'code', partLabel: 'a', keywords: ['return', 'Library:', 'toString'] }
    ],
...
- toString() — returns "name: avg=X.X, best=Y" (1 decimal place for avg)`,
    ...
    rubric: [
      ...
      { points: 1, description: 'toString() returns correct overall format', index: 7, skill: 'code', partLabel: 'a', keywords: ['return', 'avg=', 'toString'] }
    ],
...
public class ListFilter {
    ...
    rubric: [
      ...
      { points: 1, description: '(b) Iterates through all elements of data', index: 4, skill: 'code', partLabel: 'b', keywords: ['for', 'while', 'data', 'ArrayList'], cpeSource: 'a' },
...
public class ArrayStatistics {
    ...
    rubric: [
      ...
      { points: 1, description: '(a) Returns correct array', index: 4, skill: 'code', partLabel: 'a', keywords: ['return', 'result', 'arr', 'total'] },
      ...
      { points: 1, description: '(b) Returns correct boolean result', index: 7, skill: 'code', partLabel: 'b', keywords: ['return', 'false', 'true'], cpeSource: 'a' }
    ],
...
public class MatrixOps {
    ...
    rubric: [
      ...
      { points: 1, description: '(a) Traverses all elements of matrix', index: 2, skill: 'code', partLabel: 'a', keywords: ['for', 'while', 'matrix'] },
      { points: 1, description: '(a) Assigns result[c][r] = matrix[r][c]', index: 3, skill: 'code', partLabel: 'a', keywords: ['transpose', 'matrix', '[c][r]', '[r][c]'] },
      { points: 1, description: '(a) Returns correct transposed matrix', index: 4, skill: 'code', partLabel: 'a', keywords: ['return', '[c][r]', '[r][c]'] },
      { points: 1, description: '(b) Traverses relevant portion of matrix (upper or lower triangle)', index: 5, skill: 'code', partLabel: 'b', keywords: ['for', 'while', 'matrix', 'transpose'], cpeSource: 'a' },
...
public class GridGame {
    ...
    rubric: [
      { points: 1, description: '(a) Iterates over all rows for the given column', index: 1, skill: 'code', partLabel: 'a', keywords: ['for', 'while', 'grid', 'columnSum'] },
      { points: 1, description: '(a) Correctly accumulates sum', index: 2, skill: 'code', partLabel: 'a', keywords: ['+=', 'columnSum', 'grid'] },
      { points: 1, description: '(a) Returns correct column sum', index: 3, skill: 'code', partLabel: 'a', keywords: ['return', 'sum', 'total', 'result'] },
      ...
      { points: 1, description: '(b) Returns correct column index', index: 7, skill: 'code', partLabel: 'b', keywords: ['return', 'bestCol', 'col', 'result'], cpeSource: 'a' }
    ],
...
Example:
  ...
  System.out.println(h); // Horse: Thunder (1100.5 lbs)`,
    ...
    rubric: [
      ...
      { points: 1, description: 'Constructor correctly initializes both fields', index: 2, skill: 'code', partLabel: 'a', keywords: ['this.', '=', 'name', 'weight'] },
      { points: 1, description: 'Getter methods return correct values', index: 3, skill: 'code', partLabel: 'a', keywords: ['getName', 'getWeight'] },
      { points: 1, description: 'toString() returns correct format: "Horse: name (weight lbs)"', index: 4, skill: 'code', partLabel: 'a', keywords: ['return', 'Horse:', 'toString'] }
    ],
...
public class GradeCalculator {
    ...
    rubric: [
      ...
      { points: 1, description: '(b) Iterates through all elements of scores array', index: 4, skill: 'code', partLabel: 'b', keywords: ['for', 'while', 'scores'], cpeSource: 'a' },
      { points: 1, description: '(b) Correctly counts and returns number of passing scores (>= 60)', index: 5, skill: 'code', partLabel: 'b', keywords: ['return', '>=', 'count', 'total', '>= 60'], cpeSource: 'a' }
    ],
...
public class ArrayHelper {
    ...
    rubric: [
      ...
      { points: 1, description: '(a) Returns the new reversed array', index: 3, skill: 'code', partLabel: 'a', keywords: ['return', '.length', '- 1'] },
      { points: 1, description: '(b) Iterates through arr and compares each element to target', index: 4, skill: 'code', partLabel: 'b', keywords: ['for', 'while', 'arr', 'reverseArray'], cpeSource: 'a' },
      { points: 1, description: '(b) Returns correct index on match or -1 if not found', index: 5, skill: 'code', partLabel: 'b', keywords: ['return', '-1'], cpeSource: 'a' }
    ],
...
public class Calculator {
    ...
    rubric: [
      ...
      { points: 1, description: '(a) Loops exp times, multiplying result by base each iteration', index: 2, skill: 'code', partLabel: 'a', keywords: ['for', 'while', '*', 'exp'] },
      { points: 1, description: '(a) Returns correct result (including base case exp==0 returning 1)', index: 3, skill: 'code', partLabel: 'a', keywords: ['return', 'result', 'total'] },
      ...
      { points: 1, description: '(b) Correctly computes factorial using a loop and returns result', index: 5, skill: 'code', partLabel: 'b', keywords: ['for', 'while', 'return', '*='], cpeSource: 'a' }
    ],
...
// }`,
    ...
    rubric: [
      ...
      { points: 1, description: '(b) Iterates through all CookieOrder objects in orders', index: 4, skill: 'code', partLabel: 'b', keywords: ['for', 'while', 'orders', 'CookieOrder'], cpeSource: 'a' },
...
// }`,
    ...
    rubric: [
      ...
      { points: 1, description: '(b) Iterates through all NumberGroup objects in groupList', index: 4, skill: 'code', partLabel: 'b', keywords: ['for', 'while', 'groupList', 'NumberGroup'], cpeSource: 'a' },
      {
        points: 1,
...
Example:
  ...
  System.out.println(d1); // Buddy (Golden Retriever, 5 years old)`,
    ...
    rubric: [
      ...
      { points: 1, description: 'Constructor correctly initializes all three fields', index: 2, skill: 'code', partLabel: 'a', keywords: ['this.', '=', 'name', 'breed', 'age'] },
      ...
      { points: 1, description: 'toString() returns correct format: "name (breed, age years old)"', index: 5, skill: 'code', partLabel: 'a', keywords: ['return', 'years', 'toString'] }
    ],
